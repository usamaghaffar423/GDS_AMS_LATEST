                        ...
                        leaveEmployees.length > 0 ? ( <
                            div className = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 justify-start" > {
                                leaveEmployees.map((employee, index) => ( <
                                    ...
                                    div className = "w-24 h-24 mb-4 rounded-full bg-gray-800 text-gray-300 text-2xl flex items-center justify-center font-bold shadow-lg border-4 border-teal-400" > { getInitials(employee.employeeName) } <
                                    /div> <
                                    h5 className = "mb-1 text-xl font-semibold text-gray-200 dark:text-white" > { employee.employeeName || "Unknown" } <
                                    /h5> <
                                    span className = "text-sm text-gray-400 dark:text-gray-500" > { employee.employeeEmail || "Employee" } <
                                    /span> <
                                    /div> <
                                    /div>
                                ))
