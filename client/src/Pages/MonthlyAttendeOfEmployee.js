        ...
        tbody > {
            attendanceRecords.map((record, index) => {
                ...
                return ( <
                    ...
                    td className = "px-6 py-4 border-b border-gray-600 text-gray-400" > { day } < /td> { /* Format Login Time */ } <
                    td className = "px-6 py-4 border-b border-gray-600 text-gray-400" > { formatTime(record.loginTime) } <
                    /td>

                    { /* Format Logout Time */ } <
                    td className = "px-6 py-4 border-b border-gray-600 text-gray-400" > { formatTime(record.logoutTime) } <
                    /td> <
                    td className = "px-6 py-4 border-b border-gray-600 text-gray-400" > { record.dailyBreakDuration || "-" } <
                    /td> <
                    /tr>
                );
            })
