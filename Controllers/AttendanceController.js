...
exports.getLoggedInEmployeeAttendance = async (req, res) => {
  ...
  try {
    ...
    attendanceRecords.forEach((record) => {
      ...
      const employeeScheduledTime = employeeDetails?.in_time || '09:00'; // Fetch dynamic scheduled time
      ...
      if (in_time) {
        ...
        isOnTime = diffInMinutes <= 16; // On time if login within 16 minutes of scheduled time
      }
